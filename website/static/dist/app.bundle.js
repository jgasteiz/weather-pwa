...
if (document.getElementById('weather-app')) {
    _reactDom2.default.render(_react2.default.createElement(_App2.default, null), document.getElementById('weather-app'));
}
...
var _OpenWeatherMap = __webpack_require__(26);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.dataTimestamp
                ),
                _react2.default.createElement(
                    'span',
                    { className: 'weather__min-max' },
                    'min: ',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('i', { className: 'weather__icon wi ' + this.state.weatherIcon }),
                    _react2.default.createElement(
                        'span',
                        {
                            className: 'weather__icon-name' },
        ...
        value: function componentDidMount() {
            ...
            _OpenWeatherMap2.default.getWeatherData(function (res) {
                _this2.setState({
...
var OpenWeatherMap = function () {
    ...
    _createClass(OpenWeatherMap, null, [{
        key: 'getWeatherData',
         ...
         * Get the weather.
         */
        value: function getWeatherData(callback) {
            fetch('/api/weather/').then(function (res) {
                return res.json();
